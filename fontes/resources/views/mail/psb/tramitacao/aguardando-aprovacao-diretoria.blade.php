...
<body>
  ...
  <div class="corpo">
    <h1>Processo Seletivo Aguardando Aprovação</h1>
    <hr>
    <div class="mensagem">
        <div class="container">
            <p style="font-family: Arial, Helvetica, sans-serif;">Olá, gestor <strong>{{ $parameters['diretoria'] }}</strong>!</p><br>
            <p style="font-family: Arial, Helvetica, sans-serif;">Um novo processo seletivo foi cadastrado para a <strong>{{ $parameters['solicitante'] }}</strong> e aguarda a sua aprovação.</p>
            <p style="font-family: Arial, Helvetica, sans-serif;">Dados do processo seletivo:</p>
