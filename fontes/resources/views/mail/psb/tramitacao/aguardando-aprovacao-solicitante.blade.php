...
<body>
  ...
  <div class="corpo">
    ...
    <div class="mensagem">
        <div class="container">
            <p style="font-family: Arial, Helvetica, sans-serif;">Olá, gestor <strong>{{ $parameters['solicitante'] }}</strong>!</p><br>
            <p style="font-family: Arial, Helvetica, sans-serif;">Um novo processo seletivo foi cadastrado para a sua área aguarda a sua aprovação.</p>
