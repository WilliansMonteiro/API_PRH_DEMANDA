...
<body style="background-color: rgba(249, 254, 255, 0.685) ">
    <div class="card">
      ...
      <div class="card-2">
        ...
        <div class="container">
        <div class="titulo">
          <h2 style="font-family: Arial, Helvetica, sans-serif;"><b>Solicitação de matrícula reprovada</b></h2>
          <hr>
        </div>
         <p style="font-family: Arial, Helvetica, sans-serif;"> <strong>PRESTADOR</strong>  - <span>{{$parameters['prestador']}}</span> </p> 
         <p style="font-family: Arial, Helvetica, sans-serif;"> <strong>EXECUTOR</strong>  - <span>{{$parameters['usuario']}}</span> </p>
         <p style="font-family: Arial, Helvetica, sans-serif;"> <strong>EMPRESA</strong>  - <span>{{$parameters['empresa']}}</span> </p>
         <p style="font-family: Arial, Helvetica, sans-serif;"> <strong>MOTIVO</strong>  - <span>{{$parameters['motivo']}}</span> </p>
